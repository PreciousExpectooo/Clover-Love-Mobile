      ...
      >
        ...
        >
          <View className="p-[20px]">
            <View className="w-full flex-row justify-center  py-8 relative">
              <TouchableOpacity
                className="absolute left-0 top-[100%] bottom-[100%]"
                onPress={() => router.back()}
              >
                <SvgBack />
              </TouchableOpacity>
              <Text className="text-[18px] font-[700]">Edit Profile</Text>
            </View>
                ...
                {showDatePicker && (
                  <View>
                    <View className="w-full flex justify-end items-end px-3 mt-2">
                      ...
                      >
                        <Text className="text-[#640D6B] font-bold text-md">
                          Done
                        </Text>
                      </TouchableOpacity>
                    </View>
                ...
                <>
                  ...
                  >
                    <FormField
                      ...
                      placeholder={
                        formData.university || "Enter University Name"
                      }
                      otherStyles="text-black"
